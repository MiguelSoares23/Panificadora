...
public class Funcionario extends Pessoa {
    ...
    private List<Cliente> clientesAtendidos; //simples

    public Funcionario(int idFuncionario, String nome, String cargo, float salario, List<Cliente> clientesAtendidos) {
        super(nome);
